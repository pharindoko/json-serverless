...
json-serverless/0.0.6-alpha.23 darwin-x64 node-v12.12.0
...
_See code: [lib/commands/create-stack.js](https://github.com/pharindoko/json-serverless/blob/v0.0.6-alpha.23/lib/commands/create-stack.js)_
...
_See code: [lib/commands/run.js](https://github.com/pharindoko/json-serverless/blob/v0.0.6-alpha.23/lib/commands/run.js)_
...
_See code: [lib/commands/update-stack.js](https://github.com/pharindoko/json-serverless/blob/v0.0.6-alpha.23/lib/commands/update-stack.js)_
<!-- commandsstop -->
