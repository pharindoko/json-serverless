...
json-serverless/0.0.2-alpha.2+c032d55 darwin-x64 node-v12.12.0
...
_See code: [src/commands/deploy.ts](https://github.com/pharindoko/json-serverless/blob/v0.0.2-alpha.2+c032d55/src/commands/deploy.ts)_
...
_See code: [src/commands/run.ts](https://github.com/pharindoko/json-serverless/blob/v0.0.2-alpha.2+c032d55/src/commands/run.ts)_
<!-- commandsstop -->
