...
json-serverless/0.0.2-alpha.1+ddec7ed darwin-x64 node-v12.12.0
...
_See code: [src/commands/deploy.ts](https://github.com/pharindoko/json-serverless/blob/v0.0.2-alpha.1+ddec7ed/src/commands/deploy.ts)_
...
_See code: [src/commands/run.ts](https://github.com/pharindoko/json-serverless/blob/v0.0.2-alpha.1+ddec7ed/src/commands/run.ts)_
<!-- commandsstop -->
